    ...
    public class BLsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.BLs != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.BLs'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.BLs'  is null.");
            }
            var bL = await _context.BLs.FindAsync(id);
            if (bL != null)
            {
        ...
        {
          return (_context.BLs?.Any(e => e.ID == id)).GetValueOrDefault();
        }
    }
}
