...
namespace BlContainerSystem.Controllers
{
    public class ContainersController : Controller
    {
        ...
        {
            ViewData["BL_ID"] = new SelectList(_context.BLs, "ID", "Consignee");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Numero,Tipo,Tamanho,BL_ID")] Container container)
        {
            ...
            ViewData["BL_ID"] = new SelectList(_context.BLs, "ID", "Consignee", container.BL_ID);
            return View(container);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Numero,Tipo,Tamanho,BL_ID")] Container container)
        {
            if (id != container.ID)
            {
                return NotFound();
